...
_L1:
        ...
        if (s == "in-http-server")
        {
            if ((i & ModuleContext.IN_HTTP_SERVER) == 0)
            {
                return false;
            }
        ...
        if ((i & ModuleContext.IN_SERVLET) == 0)
        {
            return false;
        }
        if (true) goto _L2; else goto _L3
_L3:
        String s1 = (new StringBuilder()).append("%provide%").append(s).toString().intern();
        Declaration declaration = Compilation.getCurrent().lookup(s1, -1);
