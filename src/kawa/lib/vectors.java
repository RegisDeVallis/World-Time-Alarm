...
public class vectors extends ModuleBody
{
    ...
    public Object apply1(ModuleMethod modulemethod, Object obj)
    {
        ...
        case 2: // '\002'
            ...
            {
                throw new WrongType(classcastexception3, "make-vector", 1, obj);
            }
            return makeVector(i);
        ...
        case 4: // '\004'
            ...
            {
                throw new WrongType(classcastexception2, "vector-length", 1, obj);
            }
            return Integer.valueOf(vectorLength(fvector1));
        ...
        case 7: // '\007'
            ...
            {
                throw new WrongType(classcastexception1, "vector->list", 1, obj);
            }
        ...
        {
            throw new WrongType(classcastexception, "list->vector", 1, obj);
        }
    ...
    public Object apply2(ModuleMethod modulemethod, Object obj, Object obj1)
    {
        ...
        {
            throw new WrongType(classcastexception, "vector-fill!", 1, obj);
        }
        vectorFill$Ex(fvector, obj1);
        return Values.empty;
    }
    ...
    public Object apply3(ModuleMethod modulemethod, Object obj, Object obj1, Object obj2)
    {
        if (modulemethod.selector == 5)
        {
            ...
            {
                throw new WrongType(classcastexception, "vector-set!", 1, obj);
            }
            try
            {
                i = ((Number)obj1).intValue();
            ...
            {
                throw new WrongType(classcastexception1, "vector-set!", 2, obj1);
            }
            vectorSet$Ex(fvector, i, obj2);
            return Values.empty;
        } else
        {
    ...
    public final void run(CallContext callcontext)
    {
        ...
        aobj[0] = Lit0;
        aobj[1] = vector$Mnset$Ex;
        ModuleMethod _tmp1 = vector$Mnref$Fn1;
        aobj[2] = vector$Mnref$Fn1;
