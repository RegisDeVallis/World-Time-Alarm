...
public class sorting extends ModuleBody
{
    ...
    public static Object listSort(Object obj, Object obj1)
    {
        ...
        aobj[0] = obj1;
        aobj[1] = LList.Empty;
        return srfi95.$PcSortList(append.append$V(aobj), obj, Boolean.FALSE);
    }
    ...
    public static void vectorSort(Object obj, Object obj1)
    {
        ...
        {
            throw new WrongType(classcastexception, "%sort-vector", 1, obj1);
        }
    ...
    public static void vectorSort$Ex(Object obj, Object obj1)
    {
        ...
        {
            throw new WrongType(classcastexception, "%vector-sort!", 1, obj1);
        }
