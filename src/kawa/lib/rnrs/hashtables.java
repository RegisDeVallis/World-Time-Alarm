...
public class hashtables extends ModuleBody
{
    ...
    {
        gnu.lists.Pair pair = hashtable1.entriesVectorPair();
        Object aobj[] = new Object[2];
        aobj[0] = lists.car.apply1(pair);
        aobj[1] = lists.cdr.apply1(pair);
    ...
    {
        Object obj = hashtable1.hashFunction.apply1(hashtable1);
        Object obj1 = Scheme.isEqv.apply2(obj, hash$Mnby$Mnidentity);
        if (obj1 == Boolean.FALSE ? Scheme.isEqv.apply2(obj, hash$Mnfor$Mneqv) != Boolean.FALSE : obj1 != Boolean.FALSE)
        {
            obj = Boolean.FALSE;
        }
        return obj;
    ...
    public static Object isHashtableMutable(kawa.lib.kawa.hashtable.HashTable hashtable1)
    {
        ...
        return applytoargs.apply1(boolean1);
    }
    ...
    public Object apply1(ModuleMethod modulemethod, Object obj)
    {
        ...
        case 3: // '\003'
            ...
            kawa.lib.kawa.hashtable.HashTable hashtable7;
            kawa.lib.kawa.hashtable.HashTable hashtable8;
            int i;
            int j;
            try
            {
            ...
            {
                throw new WrongType(classcastexception12, "make-eq-hashtable", 1, obj);
            }
        ...
        case 5: // '\005'
            ...
            {
                throw new WrongType(classcastexception11, "make-eqv-hashtable", 1, obj);
            }
        ...
        case 10: // '\n'
            try
            {
                hashtable8 = (kawa.lib.kawa.hashtable.HashTable)obj;
            }
            catch (ClassCastException classcastexception10)
            {
                throw new WrongType(classcastexception10, "hashtable-size", 1, obj);
            }
            return Integer.valueOf(hashtableSize(hashtable8));

        case 16: // '\020'
            try
            {
                hashtable7 = (kawa.lib.kawa.hashtable.HashTable)obj;
            }
            catch (ClassCastException classcastexception9)
            {
                throw new WrongType(classcastexception9, "hashtable-copy", 1, obj);
            }
            return hashtableCopy(hashtable7);
        ...
        case 18: // '\022'
            ...
            {
                throw new WrongType(classcastexception8, "hashtable-clear!", 1, obj);
            }
            hashtableClear$Ex(hashtable6);
            return Values.empty;
        ...
        case 20: // '\024'
            ...
            {
                throw new WrongType(classcastexception7, "hashtable-keys", 1, obj);
            }
            return hashtableKeys(hashtable5);
        ...
        case 21: // '\025'
            ...
            {
                throw new WrongType(classcastexception6, "hashtable-entries", 1, obj);
            }
            return hashtableEntries(hashtable4);
        ...
        case 22: // '\026'
            ...
            {
                throw new WrongType(classcastexception5, "hashtable-equivalence-function", 1, obj);
            }
            return hashtableEquivalenceFunction(hashtable3);
        ...
        case 23: // '\027'
            ...
            {
                throw new WrongType(classcastexception4, "hashtable-hash-function", 1, obj);
            }
            return hashtableHashFunction(hashtable2);
        ...
        case 24: // '\030'
            ...
            {
                throw new WrongType(classcastexception3, "hashtable-mutable?", 1, obj);
            }
            return isHashtableMutable(hashtable1);
        ...
        case 26: // '\032'
            ...
            {
                throw new WrongType(classcastexception2, "string-hash", 1, obj);
            }
            return Integer.valueOf(stringHash(charsequence1));
        ...
        case 27: // '\033'
            ...
            {
                throw new WrongType(classcastexception1, "string-ci-hash", 1, obj);
            }
        ...
        {
            throw new WrongType(classcastexception, "symbol-hash", 1, obj);
        }
    ...
    public Object apply2(ModuleMethod modulemethod, Object obj, Object obj1)
    {
        ...
        case 7: // '\007'
            ...
            {
                throw new WrongType(classcastexception6, "make-hashtable", flag, obj);
            }
            try
            {
            ...
            {
                throw new WrongType(classcastexception7, "make-hashtable", 2, obj1);
            }
            return makeHashtable(procedure, procedure1);
        ...
        case 13: // '\r'
            ...
            {
                throw new WrongType(classcastexception5, "hashtable-delete!", flag, obj);
            }
            hashtableDelete$Ex(hashtable4, obj1);
            return Values.empty;
        ...
        case 14: // '\016'
            ...
            {
                throw new WrongType(classcastexception4, "hashtable-contains?", flag, obj);
            }
            if (isHashtableContains(hashtable3, obj1))
            {
                return Boolean.TRUE;
            } else
            {
        ...
        case 16: // '\020'
            ...
            {
                throw new WrongType(classcastexception2, "hashtable-copy", flag, obj);
            }
            try
            {
                boolean1 = Boolean.FALSE;
            ...
            {
                throw new WrongType(classcastexception3, "hashtable-copy", 2, obj1);
            }
            if (obj1 == boolean1)
            {
                flag = false;
            }
            return hashtableCopy(hashtable2, flag);
        ...
        {
            throw new WrongType(classcastexception, "hashtable-clear!", flag, obj);
        }
        try
        {
        ...
        {
            throw new WrongType(classcastexception1, "hashtable-clear!", 2, obj1);
        }
        hashtableClear$Ex(hashtable1, i);
        return Values.empty;
    }
    ...
    public Object apply3(ModuleMethod modulemethod, Object obj, Object obj1, Object obj2)
    {
        ...
        case 7: // '\007'
            ...
            {
                throw new WrongType(classcastexception2, "make-hashtable", 1, obj);
            }
            try
            {
                procedure1 = (Procedure)obj1;
            ...
            {
                throw new WrongType(classcastexception3, "make-hashtable", 2, obj1);
            }
            try
            {
            ...
            {
                throw new WrongType(classcastexception4, "make-hashtable", 3, obj2);
            }
            return makeHashtable(procedure, procedure1, i);
        ...
        case 11: // '\013'
            ...
            {
                throw new WrongType(classcastexception1, "hashtable-ref", 1, obj);
            }
            return hashtableRef(hashtable2, obj1, obj2);
        ...
        {
            throw new WrongType(classcastexception, "hashtable-set!", 1, obj);
        }
        hashtableSet$Ex(hashtable1, obj1, obj2);
        return Values.empty;
    }
    ...
    public Object apply4(ModuleMethod modulemethod, Object obj, Object obj1, Object obj2, Object obj3)
    {
        if (modulemethod.selector == 15)
        {
            ...
            {
                throw new WrongType(classcastexception, "hashtable-update!", 1, obj);
            }
            try
            {
            ...
            {
                throw new WrongType(classcastexception1, "hashtable-update!", 3, obj2);
            }
            return hashtableUpdate$Ex(hashtable1, obj1, procedure, obj3);
        } else
        {
