    ...
    implements Component, OnDestroyListener
{
    private class CallStateReceiver extends BroadcastReceiver
    {
        ...
        public void onReceive(Context context1, Intent intent)
        {
            ...
            if (!"android.intent.action.PHONE_STATE".equals(s)) goto _L2; else goto _L1
_L1:
            String s1 = intent.getStringExtra("state");
            if (!TelephonyManager.EXTRA_STATE_RINGING.equals(s1)) goto _L4; else goto _L3
_L3:
            status = 1;
...
_L4:
            ...
            continue; /* Loop/switch isn't completed */
            if (!TelephonyManager.EXTRA_STATE_IDLE.equals(s1)) goto _L6; else goto _L5
_L5:
...
_L10:
    ...
    public void PhoneCallEnded(int i, String s)
    {
        ...
        aobj[1] = s;
        EventDispatcher.dispatchEvent(this, "PhoneCallEnded", aobj);
    }
    ...
    public void PhoneCallStarted(int i, String s)
    {
        ...
        aobj[0] = Integer.valueOf(i);
        aobj[1] = s;
        EventDispatcher.dispatchEvent(this, "PhoneCallStarted", aobj);
    }
