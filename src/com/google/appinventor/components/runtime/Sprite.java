    ...
    implements AlarmHandler, OnDestroyListener, Deleteable
{
    ...
    public void EdgeReached(int i)
    {
        ...
        } else
        {
            ...
            postEvent(this, "EdgeReached", aobj);
            return;
        }
    }
