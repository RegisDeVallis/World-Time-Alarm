...
label0:
        ...
        rotatedDrawable.setBounds((i + k / 2) - rotatedBitmap.getWidth() / 2, (j + l / 2) - rotatedBitmap.getHeight() / 2, i + k / 2 + rotatedBitmap.getWidth() / 2, j + l / 2 + rotatedBitmap.getHeight() / 2);
