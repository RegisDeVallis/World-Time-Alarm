...
label0:
    ...
    public void OrientationChanged(float f, float f1, float f2)
    {
        ...
        EventDispatcher.dispatchEvent(this, "OrientationChanged", aobj);
    }
...
_L7:
        Log.e("OrientationSensor", (new StringBuilder()).append("Illegal value for getScreenRotation(): ").append(j).toString());
_L13:
