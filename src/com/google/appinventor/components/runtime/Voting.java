    ...
    implements Component
{
    ...
    private void postSendBallot(String s, String s1)
    {
        AsyncCallbackPair asynccallbackpair = new AsyncCallbackPair() {
            ...
            public void onFailure(String s3)
            {
                Log.w("Voting", (new StringBuilder()).append("postSendBallot Failure ").append(s3).toString());
                androidUIHandler.post(s3. new Runnable() {
        ...
        String s2 = serviceURL;
        NameValuePair anamevaluepair[] = new NameValuePair[2];
        anamevaluepair[0] = new BasicNameValuePair("userchoice", s);
        anamevaluepair[1] = new BasicNameValuePair("userid", s1);
        webserviceutil.postCommand(s2, "sendballot", Lists.newArrayList(anamevaluepair), asynccallbackpair);
    }
