    ...
    implements Component
{
    ...
    public static void oneButtonAlert(Activity activity1, String s, String s1, String s2)
    {
        ...
        alertdialog.setButton(-3, s2, new android.content.DialogInterface.OnClickListener() {
    ...
    private void textInputDialog(String s, String s1, boolean flag)
    {
            ...
            Runnable runnable2)
    {
        ...
        if (flag)
        {
            alertdialog.setButton(-2, "Cancel", new android.content.DialogInterface.OnClickListener(runnable2) {
