...
public class WebServiceUtil
{
    ...
    public void postCommand(String s, String s1, List list, AsyncCallbackPair asynccallbackpair)
    {
        ...
        HttpPost httppost = new HttpPost((new StringBuilder()).append(s).append("/").append(s1).toString());
        if (list == null)
        {
            list = new ArrayList();
        }
        try
        {
            ...
            asynccallbackpair.onSuccess((String)httpClient.execute(httppost, basicresponsehandler));
            return;
        }
        ...
        {
            Log.w("WebServiceUtil", clientprotocolexception);
