    ...
    implements android.content..OnClickListener
{
    ...
    {
        val$theCallback.invoke(val$theOrigin, true, true);
    }
...
/* anonymous class */
    static final class EclairUtil._cls1 extends WebChromeClient
    {
        ...
        public void onGeolocationPermissionsShowPrompt(String s, final android.webkit.GeolocationPermissions.Callback theCallback)
        {
            ...
            alertdialog.setButton(-1, "Allow", theOrigin. new EclairUtil._cls1._cls1());
            alertdialog.setButton(-2, "Refuse", new EclairUtil._cls1._cls2());
            alertdialog.show();
        }
        ...
        // Unreferenced inner class com/google/appinventor/components/runtime/util/EclairUtil$1$2

/* anonymous class */
        class EclairUtil._cls1._cls2
