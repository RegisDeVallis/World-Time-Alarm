...
_L1:
        i;
        JVM INSTR tableswitch 190 196: default 128
    //                   190 218
    //                   191 190
    //                   192 155
    //                   193 253
...
_L24:
        ...
        if (showing() && mFullScreenPlayer != null)
        {
            ...
            bundle2.putInt("PositionKey", mFullScreenVideoView.getCurrentPosition());
            bundle2.putBoolean("PlayingKey", mFullScreenVideoView.isPlaying());
            bundle2.putString("SourceKey", mFullScreenVideoBundle.getString("SourceKey"));
            mFullScreenPlayer.fullScreenKilled(bundle2);
        }
        bundle1 = doFullScreenVideoAction(videoplayer, (Bundle)obj);
        bundle = bundle1;
          goto _L11
    }
    ...
    public void startDialog()
    {
        ...
        {
            Form form = mForm;
            VideoPlayer videoplayer = mFullScreenPlayer;
            Object aobj[] = new Object[1];
            aobj[0] = mFullScreenVideoBundle.getString("SourceKey");
            form.dispatchErrorOccurredEvent(videoplayer, "Source", 701, aobj);
            return;
        }
    }
