...
label0:
        {
            ...
            if (bundle != null)
            {
                Log.d("ReplForm", (new StringBuilder()).append("extras: ").append(bundle).toString());
                for (Iterator iterator = bundle.keySet().iterator(); iterator.hasNext(); Log.d("ReplForm", (new StringBuilder()).append("Extra Key: ").append((String)iterator.next()).toString())) { }
            }
