    ...
    implements Component, OnResumeListener, OnStopListener, OnDestroyListener, Deleteable
{
    ...
    private void playAndCheckResult()
    {
        ...
        if (streamId == 0)
        {
            ...
            aobj[0] = sourcePath;
            form.dispatchErrorOccurredEvent(this, "Play", 703, aobj);
        }
    }
...
label0:
        {
            ...
            {
                Integer integer = (Integer)soundMap.get(sourcePath);
                if (integer == null)
                {
                    break label0;
                }
                soundId = integer.intValue();
            }
            return;
        }
        ...
        try
        {
            i = MediaUtil.loadSoundPool(soundPool, this.form, sourcePath);
        }
        ...
        aobj1[0] = sourcePath;
        form1.dispatchErrorOccurredEvent(this, "Source", 701, aobj1);
        return;
    }
