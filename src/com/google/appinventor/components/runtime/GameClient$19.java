    ...
    implements AsyncCallbackPair
{
    ...
    {
        String s = jsonobject.getString("inv");
        if (!s.equals("")) goto _L2; else goto _L1
_L1:
        Info((new StringBuilder()).append(s).append(" was already invited.").toString());
_L4:
...
_L2:
        try
        {
            Info((new StringBuilder()).append("Successfully invited ").append(s).append(".").toString());
        }
