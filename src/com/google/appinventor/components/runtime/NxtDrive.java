...
public class NxtDrive extends LegoMindstormsNxtBase
{
    ...
    public void DriveMotors(String s)
    {
        ...
        do
        {
            ...
            catch (IllegalArgumentException illegalargumentexception)
            {
                ...
                form.dispatchErrorOccurredEvent(this, "DriveMotors", 407, aobj);
            }
            i++;
        } while (true);
    }
    ...
    {
        long l = (long)((360D * d) / (3.1415926535897931D * wheelDiameter));
    ...
    {
        move("MoveForward", i, (long)((360D * d) / (3.1415926535897931D * wheelDiameter)));
    }
    ...
    public void beforeDisconnect(BluetoothConnectionBase bluetoothconnectionbase)
    {
        ...
        {
            for (Iterator iterator = driveMotorPorts.iterator(); iterator.hasNext(); setOutputState("Disconnect", ((Integer)iterator.next()).intValue(), 0, 2, 0, 0, 0, 0L)) { }
        }
    }
}
