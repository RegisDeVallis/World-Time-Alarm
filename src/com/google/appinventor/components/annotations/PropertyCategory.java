...
public final class PropertyCategory extends Enum
{
    ...
    static 
    {
        ...
        PropertyCategory apropertycategory[] = new PropertyCategory[4];
        apropertycategory[0] = BEHAVIOR;
        apropertycategory[1] = APPEARANCE;
        apropertycategory[2] = DEPRECATED;
        apropertycategory[3] = UNSET;
        $VALUES = apropertycategory;
    }
}
