...
final class SendWorker extends Thread
{
    ...
    private void approvePendingReports()
    {
        ...
        for (int j = 0; j < i; j++)
        {
            ...
            {
                Log.e(ACRA.LOG_TAG, (new StringBuilder()).append("Could not rename approved report from ").append(file).append(" to ").append(file1).toString());
            }
        }
...
_L6:
        ...
        runtimeexception;
        Log.e(ACRA.LOG_TAG, (new StringBuilder()).append("Failed to send crash reports for ").append(s).toString(), runtimeexception);
        deleteFile(context1, s);
          goto _L2
