...
public class FluidLetExp extends LetExp
{
    ...
    public void compile(Compilation compilation, Target target)
    {
        ...
        variable = scope.addVariable(codeattr, Compilation.typeCallContext, null);
        compilation.loadCallContext();
        codeattr.emitStore(variable);
        avariable = new Variable[inits.length];
        declaration = firstDecl();
        doInits(declaration, 0, avariable, compilation, variable);
        ...
        {
            declaration.load(null, 2, compilation, Target.pushObject);
