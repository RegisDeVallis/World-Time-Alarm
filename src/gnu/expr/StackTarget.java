...
_L2:
        ...
        if (type1.isVoid())
        {
            ...
            type1 = Type.pointer_type;
        } else
        if ((type1 instanceof PrimType) && (type2 instanceof PrimType))
        {
...
_L4:
        if (CodeAttr.castNeeded(type1.getImplementationType(), type2.getImplementationType()))
        {
            return false;
        }
        if (true) goto _L1; else goto _L3
_L3:
        type2.emitConvertFromPrimitive(type1, codeattr);
        type1 = codeattr.topType();
          goto _L4
