...
_L5:
    ...
    {
        int i = -2 + "A:java.lang.Byte;B:java.lang.Short;C:java.lang.Integer;D:java.lang.Long;E:gnu.math.IntNum;E:java.gnu.math.BitInteger;G:gnu.math.RatNum;H:java.lang.Float;I:java.lang.Double;I:gnu.math.DFloNum;J:gnu.math.RealNum;K:gnu.math.Complex;L:gnu.math.Quantity;K:gnu.math.Numeric;N:java.lang.Number;".indexOf(s);
        if (i < 0)
        {
            return '\0';
        } else
...
_L2:
        ...
        i = 0;
        c;
        JVM INSTR lookupswitch 9: default 168
    //                   66: 239
    //                   67: 221
    //                   68: 274
    //                   70: 267
...
_L13:
        return 1;
_L14:
        flag1 = s.equals("java.lang.Boolean");
        j = 0;
        if (flag1) goto _L16; else goto _L15
_L15:
        flag = s.equals("java.lang.Character");
        i = 0;
...
_L19:
    ...
    public void emitCoerceToObject(CodeAttr codeattr)
    {
        ...
        {
            method = classtype.getDeclaredMethod("valueOf", atype);
        } else
        {
            method = classtype.getDeclaredMethod("<init>", atype);
