...
_L3:
        Object obj = constantpool.addString((String)value);
_L6:
        value_index = ((CpoolEntry) (obj)).getIndex();
_L2:
        return;
_L4:
        if (value instanceof Integer)
        {
            obj = constantpool.addInt(((Integer)value).intValue());
        } else
        if (value instanceof Long)
        {
            obj = constantpool.addLong(((Long)value).longValue());
        } else
        if (value instanceof Float)
        {
            obj = constantpool.addFloat(((Float)value).floatValue());
        } else
        {
            boolean flag = value instanceof Long;
            obj = null;
            if (flag)
            {
                obj = constantpool.addDouble(((Double)value).doubleValue());
            }
        }
...
_L5:
    ...
    public Object getValue(ConstantPool constantpool)
    {
        ...
        cpoolentry = constantpool.getPoolEntry(value_index);
        cpoolentry.getTag();
...
_L1:
        return value;
_L6:
        value = ((CpoolString)cpoolentry).getString().getString();
        continue; /* Loop/switch isn't completed */
_L2:
        value = new Integer(((CpoolValue1)cpoolentry).value);
        continue; /* Loop/switch isn't completed */
_L4:
        value = new Long(((CpoolValue2)cpoolentry).value);
        continue; /* Loop/switch isn't completed */
_L3:
        value = new Float(Float.intBitsToFloat(((CpoolValue1)cpoolentry).value));
        continue; /* Loop/switch isn't completed */
_L5:
        value = new Double(Double.longBitsToDouble(((CpoolValue2)cpoolentry).value));
