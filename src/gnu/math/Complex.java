...
public abstract class Complex extends Quantity
{
    ...
    public static Complex divide(Complex complex, Complex complex1)
    {
        ...
        } else
        {
            ...
            RealNum realnum1 = complex.im();
            RealNum realnum2 = complex1.re();
            RealNum realnum3 = complex1.im();
            RealNum realnum4 = RealNum.add(RealNum.times(realnum2, realnum2), RealNum.times(realnum3, realnum3), 1);
            RealNum realnum5 = RealNum.add(RealNum.times(realnum, realnum2), RealNum.times(realnum1, realnum3), 1);
            RealNum realnum6 = RealNum.add(RealNum.times(realnum1, realnum2), RealNum.times(realnum, realnum3), -1);
            return make(RealNum.divide(realnum5, realnum4), RealNum.divide(realnum6, realnum4));
        }
    }
    ...
    {
        return new DComplex(d * Math.cos(d1), d * Math.sin(d1));
    }
    ...
    public static Complex times(Complex complex, Complex complex1)
    {
        ...
        RealNum realnum2 = complex1.re();
        RealNum realnum3 = complex1.im();
        return make(RealNum.add(RealNum.times(realnum, realnum2), RealNum.times(realnum1, realnum3), -1), RealNum.add(RealNum.times(realnum, realnum3), RealNum.times(realnum1, realnum2), 1));
    }
    ...
    public String toString(int i)
    {
        ...
        {
            s = (new StringBuilder()).append(im().toString(i)).append("i").toString();
            if (s.charAt(0) != '-')
            {
