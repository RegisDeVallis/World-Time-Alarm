...
public class PrimOps extends ModuleBody
{
    ...
    public static transient Object apply(Object obj, Object aobj[])
    {
        ...
        {
            procedure = (Procedure)symbolFunction(obj);
        } else
        {
            procedure = (Procedure)obj;
        }
        return procedure.applyN(Apply.getArguments(aobj, 0, apply));
    }
    ...
    public static FString substring(CharSequence charsequence, Object obj, Object obj1)
    {
        ...
        if (Scheme.numLss.apply2(obj1, Lit1) != Boolean.FALSE)
        {
            obj1 = AddOp.$Mn.apply2(Integer.valueOf(strings.stringLength(charsequence)), obj1);
        }
        if (Scheme.numLss.apply2(obj, Lit1) != Boolean.FALSE)
        {
            obj = AddOp.$Mn.apply2(Integer.valueOf(strings.stringLength(charsequence)), obj);
        }
        return new FString(charsequence, ((Number)obj).intValue(), ((Number)AddOp.$Mn.apply2(obj1, obj)).intValue());
    }
    ...
    public Object apply2(ModuleMethod modulemethod, Object obj, Object obj1)
    {
        ...
        case 3: // '\003'
            ...
            {
                throw new WrongType(classcastexception7, "setcar", 1, obj);
            }
            setcar(pair1, obj1);
            return Values.empty;
        ...
        case 4: // '\004'
            ...
            {
                throw new WrongType(classcastexception6, "setcdr", 1, obj);
            }
            setcdr(pair, obj1);
            return Values.empty;
        ...
        case 15: // '\017'
            ...
            {
                throw new WrongType(classcastexception5, "get", 1, obj);
            }
            return get(symbol, obj1);
        ...
        case 25: // '\031'
            try
            {
                simplevector1 = (SimpleVector)obj;
            }
            catch (ClassCastException classcastexception3)
            {
                throw new WrongType(classcastexception3, "aref", 1, obj);
            }
            try
            {
            ...
            {
                throw new WrongType(classcastexception4, "aref", 2, obj1);
            }
            return aref(simplevector1, j);

        case 27: // '\033'
            try
            {
                simplevector = (SimpleVector)obj;
            }
            catch (ClassCastException classcastexception2)
            {
                throw new WrongType(classcastexception2, "fillarray", 1, obj);
            }
            return fillarray(simplevector, obj1);
        ...
        case 29: // '\035'
            ...
            {
                throw new WrongType(classcastexception1, "make-string", 1, obj);
            }
        ...
        return substring(charsequence, obj1);
    }
    ...
    public Object apply3(ModuleMethod modulemethod, Object obj, Object obj1, Object obj2)
    {
        ...
        case 26: // '\032'
            ...
            {
                throw new WrongType(classcastexception1, "aset", 1, obj);
            }
            try
            {
            ...
            {
                throw new WrongType(classcastexception2, "aset", 2, obj1);
            }
            return aset(simplevector, i, obj2);
        ...
        return substring(charsequence, obj1, obj2);
    }
