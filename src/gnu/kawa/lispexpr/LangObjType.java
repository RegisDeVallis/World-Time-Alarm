    ...
    implements TypeValue
{
    ...
    public static ClassType coerceToClassTypeOrNull(Object obj)
    {
        ...
        if (obj instanceof Class)
        {
            Type type = Language.getDefaultLanguage().getTypeFor((Class)obj);
...
_L13:
        i = getImplementationType().compare(type.getImplementationType());
_L8:
        return i;
_L2:
        if (type == typeType || type == typeClassType || type == typeType.implementationType) goto _L8; else goto _L7
_L7:
...
_L4:
        ...
        if (type == typeType) goto _L8; else goto _L9
_L9:
        ...
        continue; /* Loop/switch isn't completed */
_L5:
        if (!(type instanceof PrimType)) goto _L6; else goto _L10
_L10:
...
_L12:
    ...
    public void emitConvertFromPrimitive(Type type, CodeAttr codeattr)
    {
        ...
        s = null;
        i;
        JVM INSTR tableswitch 7 15: default 64
    //                   7 185
    //                   8 185
    //                   9 185
    //                   10 185
    ...
    //                   14 64
    //                   15 94;
           goto _L1 _L2 _L2 _L2 _L2 _L1 _L1 _L1 _L1 _L3
_L1:
        boolean flag;
        int j;
        boolean flag1;
...
_L3:
        flag1 = type instanceof PrimType;
        obj = null;
        s = null;
        if (flag1)
        {
            ...
            PrimType primtype1 = Type.doubleType;
            obj = null;
            s = null;
            if (type == primtype1)
            {
          ...
          goto _L1
_L2:
        flag = type instanceof PrimType;
        obj = null;
        s = null;
        if (!flag) goto _L1; else goto _L4
_L4:
        if (type != Type.intType && type != Type.byteType && type != Type.shortType) goto _L6; else goto _L5
_L5:
        s = "gnu.math.IntNum";
        obj = Type.int_type;
          goto _L1
_L6:
        if (type != Type.longType) goto _L8; else goto _L7
_L7:
        s = "gnu.math.IntNum";
        obj = Type.long_type;
          goto _L1
_L8:
        if (typeCode == 9) goto _L10; else goto _L9
_L9:
        j = typeCode;
        obj = null;
        s = null;
        if (j != 10) goto _L1; else goto _L10
_L10:
        ...
        PrimType primtype = Type.doubleType;
        obj = null;
        s = null;
        if (type == primtype)
        {
