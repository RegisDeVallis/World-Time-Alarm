...
public class XStringType extends XDataType
{
    ...
    public boolean isInstance(Object obj)
    {
        if (obj instanceof XString)
        {
            Object obj1 = ((XString)obj).getStringType();
            while (obj1 != null) 
            {
                if (obj1 == this)
                {
    ...
    public String matches(String s)
    {
        ...
        if (s == TextUtils.replaceWhitespace(s, flag1))
        {
            flag = true;
        } else
        {
    ...
    public Object valueOf(String s)
    {
        ...
        s1 = TextUtils.replaceWhitespace(s, flag);
        if (matches(s1) != null)
        {
            throw new ClassCastException((new StringBuilder()).append("cannot cast ").append(s1).append(" to ").append(name).toString());
        } else
        {
            return new XString(s1, this);
        }
    }
