...
_L1:
        KNode knode1 = KNode.make((NodeTree)obj);
_L5:
        boolean flag;
        KNode knode;
        if (!isInstance(knode1.sequence, knode1.ipos, i))
        {
            knode1 = null;
        }
        knode = knode1;
...
_L3:
    ...
    {
        int k = abstractsequence.getNextKind(i);
...
_L18:
    ...
    {
        ApplyExp applyexp = new ApplyExp(coerceMethod, new Expression[] {
            expression
        });
