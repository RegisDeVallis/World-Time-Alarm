...
public class lambda.Fn8 extends ModuleBody
{
    ...
    Object lambda13(Object obj, Object obj1)
    {
        ...
        .staticLink = this;
        .fdigs = obj1;
        ModuleMethod modulemethod = .Fn10;
         1 = staticLink.staticLink.staticLink;
         2 = new <init>();
        2.staticLink = 1;
        2.cont = modulemethod;
        if (Scheme.numGEq.apply2(obj, Integer.valueOf(staticLink.staticLink.staticLink.)) != Boolean.FALSE)
        {
            return Scheme.applyToArgs.apply3(2.cont, obj, printf.Lit1);
        }
        Object obj2 = staticLink.staticLink.staticLink.tr;
        CharSequence charsequence;
        int i;
        try
        {
        ...
        {
            return staticLink.staticLink.staticLink.ambda2sign(AddOp.$Pl.apply2(obj, printf.Lit7), 2.Fn11);
        } else
        {
            return Scheme.applyToArgs.apply3(2.cont, obj, printf.Lit1);
        }
