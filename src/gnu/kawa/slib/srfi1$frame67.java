...
{
    public class srfi1.frame68 extends ModuleBody
    {
        ...
        {
            srfi1.frame69 frame69_1 = new srfi1.frame69();
            frame69_1.staticLink = this;
            frame69_1.list = obj;
            frame69_1.other$Mnlists = obj1;
            return call_with_values.callWithValues(frame69_1.lambda$Fn73, frame69_1.lambda$Fn74);
        }
    ...
    public static Object lambda92recur(Object obj)
    {
        ...
        {
            return call_with_values.callWithValues(.Fn71, .Fn72);
        } else
        {
            Object aobj[] = new Object[2];
            aobj[0] = LList.Empty;
