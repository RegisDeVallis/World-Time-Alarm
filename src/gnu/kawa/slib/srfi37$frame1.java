...
public class  extends ModuleBody
{
    ...
    Object lambda11$V(Object aobj[])
    {
        ...
        return staticLink.ambda5scanArgs(lists.cdr.apply1(args), llist);
    }
    ...
    {
        LList llist = LList.makeList(aobj, 0);
        return staticLink.ambda3scanShortOptions(AddOp.$Pl.apply2(index, srfi37.Lit0), shorts, args, llist);
    }
    ...
    {
        LList llist = LList.makeList(aobj, 0);
        return staticLink.ambda5scanArgs(args, llist);
    }
